...
// var iAmStandBy;
// console.log(iAmStandBy);//undeifned
// console.log(typeof(iAmStandBy));//undeifed
...
This is called type coercion. === does not do any type conversion (coercion)
 and returns true only if both values and types are identical*/
// sol 
// var num1 = 5;
// var num2 = '5';
...
/**for..in iterates over all enumerable property keys of an object. for..of iterates over the values of an iterable objec */
// var myFriends = ['vinod','ramesh','arjun','vishal'];
...
//this point to immediate parent
...
//In case arrow function this parent ke bhi parent se lta value
...
Asynchronous is a non-blocking architecture, so the execution of one task isn't dependent on another.
 Tasks can run simultaneously. Synchronous is a blocking architecture, 
so the execution of each operation is dependent on the completion of the one before i */
